        ...
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            ...
            <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                <div className="space-y-3">
                    <h3 className="tracking-wide uppercase dark:text-gray-900">Site Services</h3>
                    <ul className="space-y-1">
                        <li>
                            <a rel="noopener noreferrer" href="/health-conditions" >Health Conditions</a>
                        </li>
                        <li>
                            <a rel="noopener noreferrer" href="/self-diagnosis">Self Diagnosis</a>
                        </li>
                        <li>
                            <a rel="noopener noreferrer" href="/hospitals">Hospitals</a>
                        </li>
                    </ul>
                </div>
                <div className="space-y-3">
                    <h3 className="tracking-wide uppercase dark:text-gray-900">Information</h3>
                    <ul className="space-y-1">
                        <li>
                            <a rel="noopener noreferrer" href="/about-us">About Us</a>
                        </li>
                        <li>
                            <a rel="noopener noreferrer" href="/faqs">FAQs</a>
                        </li>
                    </ul>
                </div>
                <div className="space-y-3">
                    ...
                    <ul className="space-y-1">
                        <li>
                            <a rel="noopener noreferrer" href="/about-us">Privacy Policy</a>
                        </li>
                        <li>
                            <a rel="noopener noreferrer" href="/faqs">Terms & Conditions</a>
                        </li>
                    </ul>
                </div>
                <div className="space-y-3">
